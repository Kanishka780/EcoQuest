...
# Set up environment variables required for client-side compilation during build.
# Note: These values should be passed as build-args when building the container.
